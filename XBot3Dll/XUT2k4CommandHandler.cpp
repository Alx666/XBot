...
void XUT2k4CommandHandler::buildCommandList()
{
	...
	static string Scommand[] = {string("setWeaponRange"),string("setTimeoutWeaponAutoSwap"),
								string("setImodeType"),string("setAimSpeed"),string("setUnlockStrenght"),string("setPlayerSpeedMode"),
	...
	static string Gcommand[] = {string("getPlayerList"),string("getAutoSwapWeaponComboList"),string("")};
