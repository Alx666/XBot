...
interface FAKE_IDirect3DDevice8 : public IDirect3DDevice8
{
public:
	...
	//Direct3DDevice8 FUNCTION PROTOTYPES
	...
	HRESULT __stdcall CreateAdditionalSwapChain(D3DPRESENT_PARAMETERS* pPresentationParameters, IDirect3DSwapChain8** ppSwapChain);
	...
	HRESULT __stdcall LightEnable(DWORD LightIndex, BOOL bEnable);
	...
	HRESULT __stdcall GetCurrentTexturePalette(UINT* pPaletteNumber);
	HRESULT __stdcall DrawPrimitive(D3DPRIMITIVETYPE PrimitiveType, UINT StartVertex, UINT PrimitiveCount);
	HRESULT __stdcall DrawIndexedPrimitive(D3DPRIMITIVETYPE Type, UINT MinIndex, UINT NumVertices, UINT StartIndex, UINT PrimitiveCount);
	...
	HRESULT __stdcall DrawIndexedPrimitiveUP(D3DPRIMITIVETYPE PrimitiveType, UINT MinIndex, UINT NumVertices, UINT PrimitiveCount, CONST void* pIndexData, D3DFORMAT IndexDataFormat, CONST void* pVertexStreamZeroData, UINT VertexStreamZeroStride);
